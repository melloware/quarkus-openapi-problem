...
class JsonMappersIT {
    ...
    void shouldThrowBadRequestOnDifferentlyMalformedBody() {
        given()
                ...
                .then()
                .statusCode(BAD_REQUEST.getStatusCode())
                .body("detail", oneOf(JACKSON_MALFORMED_PAYLOAD_DETAIL, JSONB_CLASSIC_MALFORMED_PAYLOAD_DETAIL,
                        JSONB_REACTIVE_MALFORMED_PAYLOAD_DETAIL, QUARKUS_2_15_JACKSON_REACTIVE_ERROR_DETAIL));
    }
    ...
    void shouldThrowBadRequestForInvalidFieldFormat() throws IOException {
        ...
        response.body("detail",
                oneOf(JACKSON_FIELD_SERIALIZATION_ERROR_DETAIL, JSONB_CLASSIC_FIELD_SERIALIZATION_ERROR_DETAIL,
                        JSONB_REACTIVE_FIELD_SERIALIZATION_ERROR_DETAIL))
