...
/**
 * REST client interface for interacting with Service One.
 * This client provides endpoints to trigger specific HTTP error responses
 * and retrieve a greeting message.
 *
 * <p>It is registered as a MicroProfile Rest Client with the configuration key <b>"service-one"</b>.
 ...
 */
@RegisterRestClient(configKey = "service-one")
