package io.quarkiverse.openapi.problem.devmode;
...
public class PropertiesLiveReloadTest {
    ...
    static final String ORIGINAL_PROPERTY_NAME = "context.field-from-configuration";
    static final String NEW_PROPERTY_NAME = "context.another-field-from-configuration";
